...
switch (driverName)
        {
	case"Google Chrome":
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Rashmi\\eclipse\\java-2020-03\\eclipse\\chromedriver.exe");
			this.driver = new ChromeDriver();
break;	
		default:    System.setProperty("webdriver.chrome.driver", "C:\\Users\\Rashmi\\eclipse\\java-2020-03\\eclipse\\chromedriver.exe");
		this.driver = new ChromeDriver();
break;
        }
    }
